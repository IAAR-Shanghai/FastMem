...
class GenerationMixin:
    ...
    def generate(
        ...
        # todo 每次训练之前要把上面的输入和下面的greddy注释掉
        ...
        if generation_mode == GenerationMode.GREEDY_SEARCH and contrastive_decoding:
    ...
    def relative_top_filter(self, scores: torch.FloatTensor, relative_top: float = 0.1,
        ...
        while True:
            ...
            dict_outputs, outputs = self(
                **model_inputs,
                ...
                epoch=0,
                choose_dola=training_args.choose_dola,
